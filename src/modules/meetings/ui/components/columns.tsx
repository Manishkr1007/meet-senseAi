...
import { CircleCheck ,CircleCheckIcon,CircleXIcon,ClockArrowDownIcon,ClockArrowUpIcon,ClockFadingIcon,CornerDownRightIcon,LoaderIcon } from "lucide-react"
...
export const columns: ColumnDef<MeetingGetMany[number]>[] = [
  ...
  },
  {
    ...
    header:"Status",
    cell:({row})=>{
     const Icon = statusIconMap[row.original.status as keyof typeof statusIconMap] || CircleCheckIcon;
     return(
        <Badge
